 ...
 */
@WebServlet("/todo3")
public class todo2Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd=request.getRequestDispatcher("/WEB-INF/views/todo2.jsp");    
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/todo2.jsp");
