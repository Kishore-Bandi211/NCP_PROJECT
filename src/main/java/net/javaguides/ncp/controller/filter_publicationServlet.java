 ...
 */
@WebServlet("/filterpublication")
public class filter_publicationServlet extends HttpServlet {
...
//	private filter_publicationDao filter_publicationdao = new filter_publicationDao();
    public filter_publicationServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/filter_publication.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd=request.getRequestDispatcher("/WEB-INF/views/filter_publication.jsp");    
