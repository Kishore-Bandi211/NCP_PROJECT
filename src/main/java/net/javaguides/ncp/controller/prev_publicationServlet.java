 ...
 */
@WebServlet("/prev_publication")
public class prev_publicationServlet extends HttpServlet {
    ...
    public prev_publicationServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/prev_publication.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd=request.getRequestDispatcher("/WEB-INF/views/prev_publication.jsp");    
