...
<body>
   ...
   <a href="faculty_home"><button class="button">Home</button></a>

    <h2 id="filter"> Filter Publications</h2>
    <div id="searchbar">
	<form method="post">
...
<div id="papers">
            <div class="row">
<%
  List<filter_publication> pdts = (List<filter_publication>) request.getAttribute("list");
  if(pdts!=null){
    for(filter_publication prod: pdts){
       %>
       <div class="column">
                    <div class="card">
